...
<body>
    ...
    <section class="aboutme">
        <div class="infos">
            ...
            <p>
                I’m currently learning being a web developer to enhance my ability to create dynamic
            ...
            <div class="tools">
                <ul>
                    ...
                    <li><img src="Images/bootstrap.png" alt="Bootstrap Logo"></li>
        ...
        <div class="cards">
            <div class="skill-cards">
                <div class="project-card1 focus-card">
                    <img src="Images/bootstrapcard.png" alt="card">
                </div>

                <div class="project-card2 focus-card">
                    <img src="Images/csscard.png" alt="card">
                </div>

                <div class="project-card3 focus-card">
                    <img src="Images/htmlcard.png" alt="card">
                </div>

                <div class="project-card4 focus-card">
                    <img src="Images/javascriptcard.png" alt="card">
                </div>

                <div class="project-card5 focus-card">
                    <img src="Images/figmacard.png" alt="card">
                </div>
